...
import hu.gpsoft.init.ModBlocks;
import hu.gpsoft.init.ModItems;
import hu.gpsoft.object.Bounds;
import hu.gpsoft.util.CollisionHelper;
...
public class AIO extends BlockColoredDevice {
    ...
    public AIO(EnumDyeColor color) {
        super("aio_pc_block", color);
